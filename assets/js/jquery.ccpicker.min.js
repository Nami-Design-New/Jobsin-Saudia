!(function (e) {
    ...
    return (
      ...
      this.init(),
      {
        setCountryByPhoneCode: function (t) {
          ...
          c._ccPicker.html(c.createCountryListItem(o.code, o.phoneCode)),
            c._ccDialCodeTrackerField.val(o.phoneCode),
            (c._ccSelectedCountry = { code: o.code, phoneCode: o.phoneCode }),
  ...
  e.extend(r.prototype, {
    ...
    createCountryList: function (t) {
      ...
      (t._list = e("<ul/>", { class: "cc-picker-code-list" }).appendTo("body")),
        t._list.css({
          top:
            t._ccPicker.offset().top +
            t._ccPicker.outerHeight() +
            (!0 === t.options.countryFilter ? 25 : 0),
          left: t._ccPicker.offset().left,
          "z-index": o
        }),
        e.each(t._ccData, function (o, c) {
          var i = e("<li>", { text: c.countryName }).appendTo(t._list);
          e(i).data("countryItem", c),
            e(i).prepend(t.createCountryListItem(c.code, c.phoneCode)),
        ...
        t.options.countryFilter &&
          ...
          t._filter.on("keyup", function (t) {
            var o = e(this).val();
            e('.cc-picker-code-list li:not(:ccContains("' + o + '"))').hide(),
              e('.cc-picker-code-list li:ccContains("' + o + '")').show();
          }));
    },
    destroyCountryList: function (e) {
      e._list.remove(),
        (e._list = {}),
        e.options.countryFilter && (e._filter.remove(), (e._filter = {}));
    },
    ...
    e.extend(e.expr[":"], {
      ccContains: function (t, o, c) {
        return e(t).text().toUpperCase().indexOf(c[3].toUpperCase()) >= 0;
      }
    }),
        ...
        return (
          this.each(function () {
            if (
              ...
              throw new Error("Method " + n + " does not exist on jQuery." + i);
